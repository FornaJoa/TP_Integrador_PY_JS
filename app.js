...
function cambiarVista(vistaActiva){
    ...
    vistaActiva.classList.remove("hidden") //elimina las vistas ocultas
    vistaActiva.classList.add("block")    //muestra la vista activa
}
...
//funcion para darle forma a las cards de los articulos
...
// dibuja la ventana emergente y la muestra en pantalla con la info del articulo elegido 
function ventanaDeDetalle(articulo) {
    ...
    // saco el estado hidden para que se muestr en pantalla
    modal.classList.remove("hidden")

    // funcionalidad al boton cerrar
    document.getElementById("btn-cerrar-modal").addEventListener("click", () => {
        modal.classList.add("hidden")
    });
}

// vista del catalogo cargado
...
async function getArticuloPorId(id) {
    try {
        ...
        ventanaDeDetalle(articulo) // Llamamos a la función que arma el modal
